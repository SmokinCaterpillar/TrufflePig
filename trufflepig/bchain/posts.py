...
So this time the *spelling errors* have an importance of **{spelling_percent:.1f}%** in comparison to *style* with **{style_percent:.1f}%**. Yet, the biggest and most important part is the actual *content* you post about, with all LSA topics together accumulating to **{topic_percent:.1f}%**.
...
"""
    ...
    title = """I am a Bot using Artificial Intelligence to help the Steemit Community. Here's how I work and what I learned this week. ({week_date})"""
